...
**Your differentiator:** "In my SkillSpring project, I built a full production FastAPI backend — 10,687 lines of code, 50+ Pydantic models, async LLM integration, and deployment on Railway. I understand the full lifecycle from schema design to deployment."
...
| **LLMs** | Used Groq (Llama-3.3) in production for text summarization and career recommendations in SkillSpring |
...
| **SkillSpring (FastAPI)** | HIGH | REST API design, database integration, production deployment |
