# P08: SkillSpring (TrainPI) - AI-Powered Career Guidance & Learning Platform

> **Project Type:** Self-Project | **Timeline:** Summer 2025
> **Live Demo:** [skillspring001.vercel.app](https://skillspring001.vercel.app/)
> **GitHub:** [github.com/rahul370139/SkillSpring](https://github.com/rahul370139/SkillSpring)
...
- UUID normalization: non-UUID user IDs converted via `uuid5(NAMESPACE_DNS, "trainpi:{id}")`
...
> "I built SkillSpring, a full-stack AI learning platform that turns any PDF into interactive learning content using RAG with Groq and Cohere, and matches users to careers using RIASEC psychometrics enhanced with embedding similarity -- deployed live on Vercel and Railway."
