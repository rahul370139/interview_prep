...
> **Rahul Sharma** -- Data Scientist who designed and shipped a production FastAPI backend (TrainPI: 10,687 lines of Python across 13 modules, 2,292-line `main.py`, 50+ Pydantic models, 74 async functions, Supabase integration, Groq LLM + Cohere embeddings).
...
16. [Your Project: TrainPI](#16-your-project-trainpi)
...
### 9c. Supabase Integration (as used in TrainPI)
...
### 10a. In-Memory LRU with TTL (as used in TrainPI)
...
|---|---|---|
| **Railway** | Git push deploy, auto-scaling, PostgreSQL add-on | Full-stack apps, TrainPI backend |
...
### 14d. LLM API Integration (as in TrainPI)
...
## 16. Your Project: TrainPI

### Architecture Overview

```
┌─────────────────────────────────────────────────────────────────────────┐
│                        TrainPI Architecture                             │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  ┌─────────────┐     ┌──────────────────────────────────────────────┐  │
...
> "I didn't just build models -- I shipped a full production API. TrainPI has 10,687 lines of FastAPI code with 50+ Pydantic schemas, async LLM integration, map-reduce summarization, LRU caching with TTL, rate limiting with exponential backoff, dual API key failover, Supabase integration with graceful fallback, and agentic AI patterns. I understand the full stack from model to deployment."
